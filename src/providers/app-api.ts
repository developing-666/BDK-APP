...
export class AppApi {
	 ...
	 */
	ocrbankcard(opts) {
		console.log(this.globalData.baiduToken);
		return this._http.postFormData('https://aip.baidubce.com/rest/2.0/ocr/v1/bankcard?access_token='+this.globalData.baiduToken, opts, false,false);
	}
	getBaiduToken(opts){
		return this._http.postFormData('https://aip.baidubce.com/oauth/2.0/token', opts, false,false);
	}
}
